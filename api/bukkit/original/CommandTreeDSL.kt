...
inline fun CommandTree.argument(
    base: Argument<*>,
    block: Argument<*>.() -> Unit = {},
): CommandTree = then(base.apply(block))

inline fun CommandTree.optionalArgument(
    base: Argument<*>,
...
inline fun CommandTree.booleanArgument(
    ...
    optional: Boolean = false,
    block: Argument<*>.() -> Unit = {},
): CommandTree = then(BooleanArgument(nodeName).setOptional(optional).apply(block))
...
inline fun CommandTree.locationArgument(
    ...
    optional: Boolean = false,
    block: Argument<*>.() -> Unit = {},
): CommandTree = then(LocationArgument(nodeName, locationType, centerPosition).setOptional(optional).apply(block))
...
): CommandTree = then(Location2DArgument(nodeName, locationType, centerPosition).setOptional(optional).apply(block))
...
inline fun CommandTree.entitySelectorArgumentOneEntity(
    ...
    optional: Boolean = false,
    block: Argument<*>.() -> Unit = {},
): CommandTree = then(EntitySelectorArgument.OneEntity(nodeName).setOptional(optional).apply(block))
...
): CommandTree = then(EntitySelectorArgument.OnePlayer(nodeName).setOptional(optional).apply(block))
...
inline fun CommandTree.scoreHolderArgumentSingle(
    ...
    optional: Boolean = false,
    block: Argument<*>.() -> Unit = {},
): CommandTree = then(ScoreHolderArgument.Single(nodeName).setOptional(optional).apply(block))
...
): CommandTree = then(ScoreHolderArgument.Multiple(nodeName).setOptional(optional).apply(block))
...
): CommandTree = then(ScoreboardSlotArgument(nodeName).setOptional(optional).apply(block))
...
): CommandTree = then(ObjectiveArgument(nodeName).setOptional(optional).apply(block))
...
): CommandTree = then(ObjectiveCriteriaArgument(nodeName).setOptional(optional).apply(block))
...
): CommandTree = then(TeamArgument(nodeName).setOptional(optional).apply(block))
...
): CommandTree = then(AdvancementArgument(nodeName).setOptional(optional).apply(block))
...
inline fun CommandTree.biomeArgument(
    ...
    if (useNamespacedKey) {
        then(
            BiomeArgument.NamespacedKey(nodeName).setOptional(optional).apply(block),
        )
    } else {
        then(BiomeArgument(nodeName).setOptional(optional).apply(block))
    }
...
): CommandTree = then(LootTableArgument(nodeName).setOptional(optional).apply(block))
...
): CommandTree = then(MathOperationArgument(nodeName).setOptional(optional).apply(block))
...
): CommandTree = then(NamespacedKeyArgument(nodeName).setOptional(optional).apply(block))
...
inline fun CommandTree.soundArgument(
    ...
    if (useNamespacedKey) {
        then(
            SoundArgument.NamespacedKey(nodeName).setOptional(optional).apply(block),
        )
    } else {
        then(SoundArgument(nodeName).setOptional(optional).apply(block))
    }
...
): CommandTree = then(WorldArgument(nodeName).setOptional(optional).apply(block))
...
inline fun CommandTree.blockPredicateArgument(
    ...
    optional: Boolean = false,
    block: Argument<*>.() -> Unit = {},
): CommandTree = then(BlockPredicateArgument(nodeName).setOptional(optional).apply(block))
...
): CommandTree = then(ItemStackPredicateArgument(nodeName).setOptional(optional).apply(block))

// NBT arguments
inline fun <NBTContainer> CommandTree.nbtCompoundArgument(
    nodeName: String,
    optional: Boolean = false,
    block: Argument<*>.() -> Unit = {},
): CommandTree = then(NBTCompoundArgument<NBTContainer>(nodeName).setOptional(optional).apply(block))
...
inline fun CommandTree.literalArgument(
    ...
    optional: Boolean = false,
    block: Argument<*>.() -> Unit = {},
): CommandTree = then(LiteralArgument.of(literal, literal).setOptional(optional).apply(block))
...
inline fun CommandTree.functionArgument(
    ...
    optional: Boolean = false,
    block: Argument<*>.() -> Unit = {},
): CommandTree = then(FunctionArgument(nodeName).setOptional(optional).apply(block))

// ArgumentTree start
inline fun Argument<*>.argument(
    base: Argument<*>,
    optional: Boolean = false,
    block: Argument<*>.() -> Unit = {},
): Argument<*> = then(base.setOptional(optional).apply(block))

inline fun Argument<*>.optionalArgument(
    base: Argument<*>,
    optional: Boolean = false,
    block: Argument<*>.() -> Unit = {
    },
...
inline fun Argument<*>.integerArgument(
    ...
    optional: Boolean = false,
    block: Argument<*>.() -> Unit = {},
): Argument<*> = then(IntegerArgument(nodeName, min, max).setOptional(optional).apply(block))
...
): Argument<*> = then(IntegerRangeArgument(nodeName).setOptional(optional).apply(block))
...
inline fun Argument<*>.longArgument(
    ...
    optional: Boolean = false,
    block: Argument<*>.() -> Unit = {},
): Argument<*> = then(LongArgument(nodeName, min, max).setOptional(optional).apply(block))
...
inline fun Argument<*>.booleanArgument(
    ...
    optional: Boolean = false,
    block: Argument<*>.() -> Unit = {},
): Argument<*> = then(BooleanArgument(nodeName).setOptional(optional).apply(block))
...
inline fun Argument<*>.stringArgument(
    ...
    optional: Boolean = false,
    block: Argument<*>.() -> Unit = {},
): Argument<*> = then(StringArgument(nodeName).setOptional(optional).apply(block))
...
): Argument<*> = then(TextArgument(nodeName).setOptional(optional).apply(block))
...
): Argument<*> = then(GreedyStringArgument(nodeName).setOptional(optional).apply(block))
...
inline fun Argument<*>.locationArgument(
    ...
    optional: Boolean = false,
    block: Argument<*>.() -> Unit = {},
): Argument<*> = then(LocationArgument(nodeName, locationType, centerPosition).setOptional(optional).apply(block))
...
): Argument<*> = then(Location2DArgument(nodeName, locationType, centerPosition).setOptional(optional).apply(block))
...
): Argument<*> = then(RotationArgument(nodeName).setOptional(optional).apply(block))
...
inline fun Argument<*>.entitySelectorArgumentOneEntity(
    ...
    optional: Boolean = false,
    block: Argument<*>.() -> Unit = {},
): Argument<*> = then(EntitySelectorArgument.OneEntity(nodeName).setOptional(optional).apply(block))
...
): Argument<*> = then(EntitySelectorArgument.OnePlayer(nodeName).setOptional(optional).apply(block))
...
): Argument<*> = then(EntityTypeArgument(nodeName).setOptional(optional).apply(block))
...
inline fun Argument<*>.scoreHolderArgumentSingle(
    ...
    optional: Boolean = false,
    block: Argument<*>.() -> Unit = {},
): Argument<*> = then(ScoreHolderArgument.Single(nodeName).setOptional(optional).apply(block))
...
): Argument<*> = then(ScoreHolderArgument.Multiple(nodeName).setOptional(optional).apply(block))
...
): Argument<*> = then(ScoreboardSlotArgument(nodeName).setOptional(optional).apply(block))
...
): Argument<*> = then(ObjectiveArgument(nodeName).setOptional(optional).apply(block))
...
): Argument<*> = then(ObjectiveCriteriaArgument(nodeName).setOptional(optional).apply(block))
...
): Argument<*> = then(TeamArgument(nodeName).setOptional(optional).apply(block))
...
inline fun Argument<*>.angleArgument(
    ...
    optional: Boolean = false,
    block: Argument<*>.() -> Unit = {},
): Argument<*> = then(AngleArgument(nodeName).setOptional(optional).apply(block))
...
): Argument<*> = then(AdvancementArgument(nodeName).setOptional(optional).apply(block))
...
): Argument<*> = then(BlockStateArgument(nodeName).setOptional(optional).apply(block))
...
): Argument<*> = then(CommandArgument(nodeName).setOptional(optional).apply(block))
...
): Argument<*> = then(EnchantmentArgument(nodeName).setOptional(optional).apply(block))
...
): Argument<*> = then(ItemStackArgument(nodeName).setOptional(optional).apply(block))
...
): Argument<*> = then(LootTableArgument(nodeName).setOptional(optional).apply(block))
...
): Argument<*> = then(MathOperationArgument(nodeName).setOptional(optional).apply(block))
...
): Argument<*> = then(NamespacedKeyArgument(nodeName).setOptional(optional).apply(block))
...
): Argument<*> = then(ParticleArgument(nodeName).setOptional(optional).apply(block))
...
): Argument<*> = then(TimeArgument(nodeName).setOptional(optional).apply(block))
...
): Argument<*> = then(UUIDArgument(nodeName).setOptional(optional).apply(block))
...
): Argument<*> = then(WorldArgument(nodeName).setOptional(optional).apply(block))
...
inline fun Argument<*>.blockPredicateArgument(
    ...
    optional: Boolean = false,
    block: Argument<*>.() -> Unit = {},
): Argument<*> = then(BlockPredicateArgument(nodeName).setOptional(optional).apply(block))
...
): Argument<*> = then(ItemStackPredicateArgument(nodeName).setOptional(optional).apply(block))

// NBT arguments
inline fun <NBTContainer> Argument<*>.nbtCompoundArgument(
    nodeName: String,
    optional: Boolean = false,
    block: Argument<*>.() -> Unit = {},
): Argument<*> = then(NBTCompoundArgument<NBTContainer>(nodeName).setOptional(optional).apply(block))
...
inline fun Argument<*>.literalArgument(
    ...
    optional: Boolean = false,
    block: Argument<*>.() -> Unit = {},
): Argument<*> = then(LiteralArgument.of(literal, literal).setOptional(optional).apply(block))
